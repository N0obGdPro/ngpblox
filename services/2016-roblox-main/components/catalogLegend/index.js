      ...
      <summary className={s.summary}>Legend</summary>
      {
        [
          ...
          },
          {
            ...
            description: 'A limited supply originally sold by NGPBLOX Each unit is labeled with a serial number. Once sold out, owners can re-sell them to other users.',
          },
        ].map(v => {
