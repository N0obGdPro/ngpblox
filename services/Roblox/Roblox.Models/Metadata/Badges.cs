...
public class BadgesMetadata
{
    public static readonly List<BadgeEntry> Badges = new List<BadgeEntry>()
    {
        ...
        new BadgeEntry(19, "Elite Builders Club", "Elite Builders Club members are among the most prestigious Robloxians. They gain exclusive perks, enhanced group limits, and a larger daily Robux allowance. Members receive 150 groups, 100 Robux per day, and many other elite benefits."),
