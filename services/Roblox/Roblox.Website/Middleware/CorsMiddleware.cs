...
public class RobloxPlayerCorsMiddleware
{
    ...
    {
        var connectSrc = "'self' https://ngpblox.noobgdpro.workers.dev wss://ngpblox.noobgdpro.workers.dev https://hcaptcha.com https://*.hcaptcha.com https://*.cdn.com";
#if DEBUG
        ...
        var scriptSrc =
            "'unsafe-eval' 'self' https://hcaptcha.com https://*.hcaptcha.com https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js https://ngpblox.noobgdpro.workers.dev";
