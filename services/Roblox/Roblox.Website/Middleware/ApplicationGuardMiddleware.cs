...
public class ApplicationGuardMiddleware
{
    ...
    private static readonly Regex RobloxPlayerDataRegex = new("^/playerdata(?:/|$)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
...
#if DEBUG
        // hCaptcha's development credentials cannot provide a real browser
        // challenge, so do not route local browser requests through it.
        uaBlocked = false;
#endif
        var bypassOk = false;
