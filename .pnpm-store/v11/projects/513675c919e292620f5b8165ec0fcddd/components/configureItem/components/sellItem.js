...
const SellItem = props => {
  ...
  return <div className='row'>
    <div className='col-12'>
      ...
      <p className='ps-2 pe-2'>Check the box below and enter a price if you want to sell this item in the NGPBLOXcatalog. Uncheck the box to remove the item from catalog.</p>
    </div>
    <div>
